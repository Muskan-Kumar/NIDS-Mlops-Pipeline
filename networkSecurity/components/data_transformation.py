...
class DataTransformation:
    ...
    def initiate_data_transformaion(self)->DataTransformationArtifact:
        ...
        try:
            ...
            train_arr=np.c_[transformed_input_train_feature,np.array(inpute_feature_train_df)]
            test_arr=np.c_[transformed_input_test_feature,np.array(inpute_feature_test_df)]
